...
- [ ] Add playwright tests and ensure they pass, target: Computer running Chrome, iPhone SE running IOS 26.1, iPhone Xr running IOS 18.7
- [ ] Create and add a simple and sleak shopping cart icon
